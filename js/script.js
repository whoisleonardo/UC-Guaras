...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        en: {
            ...
            bloggamer: 'Capybara (Hydrochoerus hydrochaeris)',
            gamerb: 'The Capybara is the largest rodent in the world, commonly found along riverbanks, lakes, and wetlands. It can weigh up to 60 kilograms and measure over a meter in length. It lives in social groups and has a calm demeanor, being seen in both natural and urban environments. Its partially webbed feet make it an excellent swimmer. It feeds on grasses, leaves, and aquatic vegetation, usually at dawn and dusk. In addition to being a seed disperser, it also plays a role in the food chain by serving as prey for predators such as jaguars and caimans.',
            alcarro: 'Tegu (Salvator merianae)',
            carrental: 'The Tegu is one of the largest lizards in South America, reaching lengths of up to 1.5 meters. It has a robust body with light spots on dark scales and lives in forests, grasslands, and even urban areas. It is a terrestrial and diurnal animal, seeking shelter in burrows or under logs. With an omnivorous diet, it feeds on fruits, eggs, small animals, and carrion, helping with ecological control and seed dispersal. During cold weather, it enters a state of torpor and reduces its activity. Despite its size, it is peaceful and essential for environmental balance.',
            cont: 'Contact',
